...
import com.lmx.boot.jpa.entity.People;
...
class PeopleRepositoryTest {
    ...
    void findByFirstNameAndLastName() {
        People people = peopleRepository.findByFirstNameAndLastName("wang", "san");
        assertEquals(people.getLastName(), "san");
    }

    @Test
    void findByFirstNameOrLastName() {
        People people = peopleRepository.findByFirstNameOrLastName("wu", "t");
        assertEquals(people.getLastName(), "si");
    }

    @Test
    void findByFirstNameIs() {
        People people = peopleRepository.findByFirstNameIs("wu");
        assertNull(people);
    }

    @Test
    void findByFirstNameEquals() {
        People people = peopleRepository.findByFirstNameEquals("qiang");
        assertNull(people);
    }
