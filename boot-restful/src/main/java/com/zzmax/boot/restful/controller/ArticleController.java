package com.zzmax.boot.restful.controller;

import com.fasterxml.jackson.annotation.JsonFormat;
import com.zzmax.boot.restful.common.AjaxResponse;
import com.zzmax.boot.restful.model.Article;
import com.zzmax.boot.restful.model.Reader;
...
public class ArticleController {
    ...
    public AjaxResponse getArticle(@PathVariable("id") Long id) {
        List<Reader> readerList = Arrays.asList(Reader.builder().name("aaaa").age(12).build(),
                Reader.builder().name("bbbb").age(13).build());
